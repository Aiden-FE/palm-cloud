...
CREATE TABLE
  `resource_folders` (
    ...
    `ownerId` CHAR(36) NOT NULL COMMENT '文件夹拥有者',
...
CREATE TABLE
  `resources` (
    ...
    `bucketName` VARCHAR(32) NOT NULL COMMENT '文件存储桶名称',
    ...
    `ownerId` CHAR(36) NOT NULL COMMENT '文件拥有者',
    `created_at` TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updated_at` TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3),
...
CREATE TABLE
  `resource_tags` (
    ...
    `ownerId` CHAR(36) NOT NULL COMMENT '标签拥有者',
    `created_at` TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updated_at` TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3),
